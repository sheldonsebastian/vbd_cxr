...
from common.utilities import bounding_box_plotter_side_to_side, merge_bb_nms
...
for iou_threshold in iou_thresholds:
    ...
    for image_id in finding_df["image_id"].unique():
        ...
        # merged_info contains boxes[0-3], labels[4]
        merged_info = merge_bb_nms(bb_df, 0, 1, 2, 3, 4, iou_thr=iou_threshold)
...
combined_df_iou_0_9.to_csv("./nms_merged/100_percent_train/fused_train_0_9.csv", index=False)
