...
# %% --------------------
for mode in ["wbf_merged", "nms_merged"]:
    ...
    # %% --------------------
    os.makedirs(MERGED_DIR + f"/{mode}/90_percent_train/2_class_classifier/90_percent",
                exist_ok=True)
    os.makedirs(MERGED_DIR + f"/{mode}/90_percent_train/2_class_classifier/10_percent",
                exist_ok=True)
