...
# %% --------------------
os.makedirs(MERGED_DIR + f"/512/unmerged/90_percent_train/object_detection/90_percent",
            exist_ok=True)
os.makedirs(MERGED_DIR + f"/512/unmerged/90_percent_train/object_detection/10_percent",
            exist_ok=True)

# %% --------------------
# save in csv
train_df.to_csv(
    MERGED_DIR + f"/512/unmerged/90_percent_train/object_detection/90_percent/train_df.csv",
    index=False)

holdout_df.to_csv(
    MERGED_DIR + f"/512/unmerged/90_percent_train/object_detection/10_percent/holdout_df.csv",
    index=False)
