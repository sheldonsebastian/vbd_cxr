...
# %% --------------------
# save in csv
train_df.to_csv(MERGED_DIR + "/wbf_merged/object_detection/train_df.csv", index=False)
holdout_df.to_csv(MERGED_DIR + "/wbf_merged/object_detection/holdout_df.csv",
                  index=False)
...
# %% --------------------
# save in csv
train_df_80.to_csv(MERGED_DIR + "/wbf_merged/object_detection/train_df_80.csv",
                   index=False)
val_df_20.to_csv(MERGED_DIR + "/wbf_merged/object_detection/val_df_20.csv",
                 index=False)
