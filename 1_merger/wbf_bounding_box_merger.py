...
for img_id in sorted(combined_df_iou_0["image_id"].unique())[:20]:
    ...
    for df, iou_thr in zip(
        ...
        bounding_box_plotter_side_to_side(im, img_id, bounding_boxes_info_before,
                                          ...
                                          save_title_or_plot=f"./wbf_merged/images/{img_id}_{iou_thr}.jpeg")

# %% --------------------
combined_df_iou_0.to_csv("./wbf_merged/fused_train_0.csv", index=False)
combined_df_iou_0_3.to_csv("./wbf_merged/fused_train_0_3.csv", index=False)
combined_df_iou_0_6.to_csv("./wbf_merged/fused_train_0_6.csv", index=False)
combined_df_iou_0_9.to_csv("./wbf_merged/fused_train_0_9.csv", index=False)
