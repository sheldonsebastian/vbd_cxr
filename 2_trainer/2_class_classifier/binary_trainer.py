...
train_tensorboard_dir = f"{TENSORBOARD_DIR}/2_class_classifier/train"
validation_tensorboard_dir = f"{TENSORBOARD_DIR}/2_class_classifier/validation"
...
saved_model_dir = Path(f"{SAVED_MODEL_DIR}/2_class_classifier/")
