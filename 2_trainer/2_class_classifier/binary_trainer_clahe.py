...
train_tensorboard_dir = f"{TENSORBOARD_DIR}/2_class_classifier/clahe/train"
validation_tensorboard_dir = f"{TENSORBOARD_DIR}/2_class_classifier/clahe/validation"
...
saved_model_dir = Path(f"{SAVED_MODEL_DIR}/2_class_classifier/clahe")
