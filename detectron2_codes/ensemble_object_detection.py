...
retinanet = pd.read_csv("D:/GWU/4 Spring 2021/6501 Capstone/VBD CXR/PyCharm "
                        "Workspace/vbd_cxr/final_outputs/holdout/holdout_retinanet.csv")
...
predictors = [retinanet, yolov5_downscaled]
...
ensembled_outputs = ensemble_object_detectors(post_processed_predictors, holdout_gt_df,
                                              upscale_height, upscale_width, iou_thr, [1, 1])
...
ensembled_outputs.to_csv(
    ensembled_output_dir + "/holdout_ensemble_retinanet_yolov5_11.csv",
    index=False)
