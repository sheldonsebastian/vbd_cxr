...
# %% --------------------
merge_iou_thr = [("0", "wbf"), ("0_3", "wbf"), ("0_6", "wbf"), ("0_9", "wbf"), ("0", "nms"),
                 ("0_3", "nms"), ("0_6", "nms"), ("0_9", "nms")]

idx = 0
if "SLURM_ARRAY_TASK_ID" in os.environ.keys():
    idx = int(os.environ["SLURM_ARRAY_TASK_ID"])

surname = merge_iou_thr[idx][0]
mode = merge_iou_thr[idx][1]
...
saved_model_dir = DETECTRON2_DIR + f"/faster_rcnn/output/{mode}/{surname}"

flag_path = DETECTRON2_DIR + "/faster_rcnn/configurations/v2.yaml"
output_dir = DETECTRON2_DIR + f"/faster_rcnn/output/inference/{mode}/{surname}"
