...
binary_prediction = pd.read_csv(
    ...
    "Workspace/vbd_cxr/final_outputs/test_predictions/test_2_class_ensembled.csv")

# read object detection outputs
object_detection_prediction = pd.read_csv(
    "D:/GWU/4 Spring 2021/6501 Capstone/VBD CXR/PyCharm "
    "Workspace/vbd_cxr/final_outputs/test_predictions"
    "/test_ensemble_faster_rcnn_retinanet_yolov5_216.csv")
...
# %% --------------------
formatted_nms.to_csv(output_directory + "/ensembled_binary_ensembled_object_detector_216.csv", index=False)
